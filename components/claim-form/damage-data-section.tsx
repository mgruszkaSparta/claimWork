...
export function DamageDataSection({
  ...
  const transportDamage: TransportDamage =
    (claimFormData.transportDamage as TransportDamage) || {
      transportType: "",
      transportTypeId: "",
      cargoDescription: "",
      losses: [""],
  ...
  const handleLossChange = (index: number, newLoss: string) => {
    ...
    handleTransportFieldChange("losses", updated)
  }

  const addLoss = () => {
    handleTransportFieldChange("losses", [...transportDamage.losses, ""])
  }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleTransportFieldChange("carrier", e.target.value)}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleTransportFieldChange("policyNumber", e.target.value)}
                  />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Input
                    ...
                    onChange={(e) =>
                      handleTransportFieldChange("inspectionContactName", e.target.value)
                    }
                  />
                  <Input
                    placeholder="Telefon"
                    ...
                    onChange={(e) =>
                      handleTransportFieldChange("inspectionContactPhone", e.target.value)
                    }
                  />
                  <Input
                    type="email"
                    ...
                    onChange={(e) =>
                      handleTransportFieldChange("inspectionContactEmail", e.target.value)
                    }
                  />
                </div>
              </div>
